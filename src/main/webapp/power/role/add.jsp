                    ...
                    <td>
						<ul>
                            <c:forEach items="${menus}" var="menu"  varStatus="sta">
                                <li><input type="checkbox" name="menuid" class="top${menu.menuid}" value="${menu.menuid}" onclick="cout(${menu.menuid})"
                            ...
                            <li>&nbsp;&nbsp;&nbsp;&nbsp
       <input type="checkbox" class="down${menu.menuid}" name="menuid" value="${twomenu.menuid}" onclick="check(${menu.menuid})">${twomenu.menuname} </li>
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="rolestate" checked value="1" />启用 <input type="radio" name="rolestate" value="0"/>禁用
                    </td>
                </tr>
